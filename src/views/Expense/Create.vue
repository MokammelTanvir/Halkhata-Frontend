    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="card border-primary">
            <div class="card-body">
              <vee-form :validation-schema="schema" @submit="saveExpense" class="mt-4 pt-2" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4">
                   <label for="category-name" class="form-label">Expense Category Name</label>
                    <vee-field as="select" class="form-select" name="expense_category_id" v-model="formData.expense_category_id">
                      <option value="">Select Expense Category Name</option>
                      <option :value="category.id" v-for="(category,index) in expenseStore.expenses_category" :key="category.id">{{ index+1 }}. {{ category.name }}</option>
                    </vee-field>
                  ...
                  <div class="col-md-6 mb-4">
                   <label for="staff-name" class="form-label">Staff Name</label>
                    <vee-field as="select" class="form-select" name="staff_id" v-model="formData.staff_id">
                  ...
                  <div class="col-md-12 mb-4">
                   <label for="expense-original_price">Expense Amount</label>
                    <vee-field type="number" class="form-control" name="amount" v-model="formData.amount" placeholder="Enter expense amount" 
                    min="0"/>
                  ...
                  <div class="col-md-12 mb-4">
                   <label for="expense-notes" class="form-label">Expense notes</label>
                    <textarea name="notes" class="form-control" id="" cols="30" rows="5" v-model="formData.notes"
